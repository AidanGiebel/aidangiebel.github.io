...
Examples of CFD simulations used to analyze aerodynamic performance and flow behavior.

### Airfoil Pressure Distribution
![Pressure Contours](images/cfd-pressure.png)

Pressure contour results showing pressure differential across an airfoil surface during subsonic flow.

---

### Velocity Field
![Velocity Contours](images/cfd-velocity.png)

Velocity contours illustrating flow acceleration over the airfoil and wake formation.

---

### Mesh Example
![Mesh](images/cfd-mesh.png)

Computational mesh used for CFD simulation with refinement near aerodynamic surfaces.
